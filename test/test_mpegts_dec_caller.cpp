/**
 * @file test_mpegts_dec_caller.cpp
 * @author your name (you@domain.com)
 * @brief Test nhận luồng mpegts từ SRT sử dụng chế độ Caller và demux sang h264 và aac
 * @version 0.1
 * @date 2023-06-09
 * 
...
int main(int argc, char const *argv[])
{
    ...
    while (1)
    {
        st = srt_recvmsg(ss, buffer, sizeof(buffer));
        if (st == SRT_ERROR)
        {
