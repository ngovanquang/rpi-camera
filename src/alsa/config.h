...
#define ALSA_CONFIG_DIR "/opt/cross-pi-gcc/bin/share/alsa"
...
#define ALSA_PKGCONF_DIR "/opt/cross-pi-gcc/bin/lib/pkgconfig"

/* directory containing ALSA add-on modules */
#define ALSA_PLUGIN_DIR "/opt/cross-pi-gcc/bin/lib/alsa-lib"
